...
Якщо 4 або більше блоків з 8 мають невалідні відповіді — ЗАМІСТЬ стандартних розділів ВИСНОВОК / СИЛЬНІ СТОРОНИ / НА ЩО ЗВЕРНУТИ УВАГУ / РЕКОМЕНДАЦІЯ / АЛЬТЕРНАТИВНІ ПОСАДИ напиши ТІЛЬКИ один блок:
