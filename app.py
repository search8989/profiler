...
ПРАВИЛА ОБҐРУНТОВАНОСТІ (КРИТИЧНО, МАЮТЬ ПРІОРИТЕТ НАД УСІМ ВИЩЕ):

1. ВИЗНАЧЕННЯ НЕВАЛІДНОЇ ВІДПОВІДІ:
Відповідь є невалідною якщо вона:
- набір випадкових букв або складів ("алдада", "бчбаба", "ьаладад", "фіваіва", "асдфг")
- повторювані символи ("ххххх", "ббббб", "...")
- беззмістовний текст без реальних слів української/російської/англійської мови
- односкладна без пояснень ("так", "ні", "не знаю", "норм")
- не стосується суті питання

2. ОБРОБКА НЕВАЛІДНИХ БЛОКІВ:
Якщо відповідь на блок невалідна — ЗАБОРОНЕНО:
- писати "ймовірно", "схоже", "враження таке", "можна припустити"
- робити будь-який психологічний аналіз
- вигадувати характеристики "з контексту"
- називати сильні чи слабкі сторони на основі цієї відповіді

ЗАМІСТЬ цього у полі "Аналіз" пиши ДОСЛІВНО:
"Відповідь невалідна. Кандидат не надав осмисленої відповіді на це питання, тому психологічний аналіз цього блоку неможливий."

3. ОБРОБКА ВСЬОГО ЗВІТУ ПРИ МАСОВІЙ НЕВАЛІДНОСТІ:
Якщо 4 або більше блоків з 8 мають невалідні відповіді — ЗАМІСТЬ стандартних розділів ВИСНОВОК / СИЛЬНІ СТОРОНИ / НА ЩО ЗВЕРНУТИ УВАГУ / РЕКОМЕНДАЦІЯ / АЛЬТЕРНАТИВНІ ПОСАДИ напиши ДВА блоки у такому порядку:

ПЕРШИЙ БЛОК — ПРОТОКОЛ ВІДПОВІДЕЙ КАНДИДАТА:

"ПРОТОКОЛ ВІДПОВІДЕЙ КАНДИДАТА

Нижче наведено всі питання тесту та фактичні відповіді кандидата — без аналізу та інтерпретації:

1. [питання 1]
Відповідь: "[дослівна цитата відповіді кандидата]"
Статус: ✅ валідна / ⚠️ невалідна

2. [питання 2]
Відповідь: "[дослівна цитата відповіді кандидата]"
Статус: ✅ валідна / ⚠️ невалідна

(і так для всіх 8 блоків)

Підсумок: X з 8 відповідей визнано невалідними."

ДРУГИЙ БЛОК — ВИСНОВОК ПРО НЕВАЛІДНІСТЬ ТЕСТУ:

"⚠️ ТЕСТ НЕ ПРОЙДЕНО КОРЕКТНО

Кандидат не надав достатньо змістовних відповідей для побудови психологічного портрету. Більшість відповідей є беззмістовними або невалідними.

Психологічний аналіз на основі таких даних неможливий і був би недостовірним.

Рекомендація: запропонувати кандидату повторно пройти тест, переконавшись що він розуміє інструкцію та готовий відповідати розгорнуто і змістовно."

ВАЖЛИВО:
- У ПРОТОКОЛІ цитуй відповіді ДОСЛІВНО, без виправлень орфографії, без перекладу, без редагування
- Не додавай психологічних коментарів до жодної відповіді у протоколі
- Статус "✅ валідна" дозволено лише якщо відповідь є осмисленим текстом українською/російською/англійською мовою з реальним змістом
- ЗАБОРОНЕНО у такому випадку видавати сильні сторони, рекомендації або альтернативні посади.

4. ЗАГАЛЬНІ ПРАВИЛА:
- Кожне твердження має спиратися на конкретну цитату з реальної відповіді кандидата
- Не вигадуй характеристик яких немає у відповідях
- Не додавай інтерпретацій що не випливають з конкретних слів
- Краще написати коротко і точно, ніж розгорнуто і вигадано
- Якщо сумніваєшся між "написати щось" і "написати недостатньо даних" — обирай друге"""
