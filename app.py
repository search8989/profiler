...
QUESTIONS_FALLBACK = {
    ...
    "deep": [
        "Чого ви хочете від роботи?", "Що найважливіше?", "Чому обрали професію?",
        "Чого хочете уникнути?", "Як розумієте успіх?", "Хто орієнтир?",
        "Найкращий досвід?", "Загальна картина чи кроки?", "Як дієте при новому?",
        "Що робите при збої?", "Інструкції чи свобода?", "Як плануєте день?",
        "Найважчий момент?", "Що робите при стресі?", "Як оцінюєте себе?",
        "Ставлення до змін?", "Термін планування?", "Що відрізняє вас?",
        "Прагнення в розвитку?", "Як справляєтесь коли все не так?",
        "Самостійно чи в команді?", "Як ставитесь до контролю?",
        "Ідеальні стосунки з командою?", "Що думаєте після важкого дня?",
        "Що важливіше — комфорт чи результат?", "Що робите коли керівник вимагає неприйнятне?",
        "Бувало що діяли інакше?", "Як організуєте інформацію?",
        "Як засвоюєте нове?", "Як зчитуєте стан інших?",
        "Що першим помічаєте на новому місці?", "Як змінювали роботи?",
        "Стабільність чи різноманіття?", "Бачите себе через 5 років?"
    ]
}
...
<div class="modes">
<div class="mode-card" data-mode="fast" onclick="selectMode('fast')"><div class="mode-name">⚡ Швидкий</div><div class="mode-desc">7 питань<br>8 метапрограм</div><div class="mode-price">{{ prices.fast }} грн</div></div>
<div class="mode-card selected" data-mode="medium" onclick="selectMode('medium')"><div class="mode-name">📊 Середній</div><div class="mode-desc">17 питань<br>14 метапрограм</div><div class="mode-price">{{ prices.medium }} грн</div></div>
<div class="mode-card" data-mode="deep" onclick="selectMode('deep')"><div class="mode-name">🧠 Глибокий</div><div class="mode-desc">34 питання<br>20 метапрограм</div><div class="mode-price">{{ prices.deep }} грн</div></div>
</div>
</div>
